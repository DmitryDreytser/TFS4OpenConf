...
namespace System.Windows
{
    ...
    public static class WinAPI
    {
        ...
        public static extern int EnableWindow(IntPtr hWnd, [MarshalAs(UnmanagedType.Bool)] bool bEnable);
    ...
    {
        public Win32CheckBox(IntPtr hWnd) : base(hWnd)
        {
        ...
        {
            if(!Style.HasFlag(WinAPI.WindowStyles.BS_AUTOCHECKBOX))
                Checked = !Checked;
        }
    ...
    public class Win32ListBox: Win32Window , IEnumerable
    {

        ArrayList Content = new ArrayList();

        public Win32ListBox(IntPtr hWnd) : base(hWnd)
        {
        ...
        {
            return Content.Contains(ItemText);
        }
    ...
    {
        public Win32TextBox(IntPtr hWnd) : base(hWnd)
        { }
    ...
    {
        public Win32Button(IntPtr hWnd) : base(hWnd)
        {
    ...
    public class SysTabControl32 : Win32Window
    {
        enum TCM_Actions
        {
        ...
        private struct TCITEM_64
        {
            ...
            internal TCITEM_64(TCITEM item)
            {
                mask = item.mask;
            ...
            static public explicit operator TCITEM(TCITEM_64 item)
            {
                TCITEM nativeItem = new TCITEM();
        ...
        public SysTabControl32() : base(IntPtr.Zero)
        {
            var Wait = new ManualResetEvent(false);
            new Thread(() =>
            {
                base.hWnd = WinAPI.CreateWindow(WinAPI.WindowTypes.SysTabControl32, base.WindowProcedure);
                Wait.Set();
                base.MessageLoop();
                base.Destroy();
            }).Start();
        ...
        public SysTabControl32(IntPtr hwnd, bool attach) : base(hwnd, attach)
        { }
        ...
        public int ItemCount {
            get {
                return SendMessage((int)TCM_Actions.TCM_GETITEMCOUNT, 0, 0).ToInt32();
                   }
        }
        ...
        public int ActiveTab
        {
            get
            {
                return SendMessage((int)TCM_Actions.TCM_GETCURSEL, 0, 0).ToInt32();
            }
        }
        ...
        public object GetActiveTab()
        {
            ...
            TCITEM item64 = new TCITEM();
            IntPtr Buffer = Marshal.AllocHGlobal(Marshal.SizeOf(typeof(TCITEM)));
       

            var result = SendMessage((int)TCM_Actions.TCM_GETITEMW, ActiveTab, Buffer);
            item64 = Marshal.PtrToStructure<TCITEM>(Buffer);
            return item64;

//            return SendMessage((int)TCM_Actions.TCM_GETITEMW, ActiveTab, 0);
        }
    ...
    public class Win32Window : IWin32Window
    {
        ...
        private GCHandle WindowProc;
        private bool Subclassed;

        [SecurityCritical]
        [HandleProcessCorruptedStateExceptions]
        private IntPtr lWndProc(IntPtr hWnd, uint uMsg, IntPtr _wParam, IntPtr _lParam, IntPtr uIdSubclass, IntPtr dwRefData)
        {
            try
            {
                ...
                if (WndProc != null)
                {
                  if (WndProc.Invoke(hWnd, uMsg, _wParam, _lParam) == 0)
                        return IntPtr.Zero;
                }

                var result = DefSubclassProc(hWnd, uMsg, _wParam, _lParam);

                ProcessMessage(new MSG { hwnd = hWnd, message = uMsg, lParam = _lParam, wParam = _wParam });
        ...
        {
            WindowsMessageSc eventHandler = new WindowsMessageSc(lWndProc).Invoke;
            WindowProc = GCHandle.Alloc(eventHandler);
            return SetWindowSubclass(hWnd, (WindowsMessageSc)WindowProc.Target, new IntPtr(505050), IntPtr.Zero);
        }
        ...
        public Win32Window(IntPtr hWnd, bool attachTo = true)
        {
            if (hWnd != IntPtr.Zero)
            {
                this.hWnd = hWnd;
        ...
        {
            if(Subclassed)
                RemoveWindowSubclass(hWnd, (WindowsMessageSc)WindowProc.Target, new IntPtr(505050));
            if (WindowProc.IsAllocated)
                WindowProc.Free();
        }
        ...
        */
        ...
        public delegate int WindowsMessage(IntPtr hWnd, uint msg, IntPtr wParam, IntPtr lParam);
        public event WindowsMessage WndProc =  delegate { return 1; };

        public delegate IntPtr WindowsMessageSc(IntPtr hWnd, uint uMsg, IntPtr wParam, IntPtr lParam, IntPtr uIdSubclass, IntPtr dwRefData);
       // public event WindowsMessageSc WndProcSc;
        ...
        public event MouseEventHandler DoubleClick = delegate { };
        ...
        private void ProcessMessage(MSG msg)
        {
            ...
            {
                case WinAPI.WM.LBUTTONDBLCLK: // Должно быть выше LBUTTONDOWN
                    {
        ...
        public IntPtr SendMessage(int Msg, int WParam, IntPtr Lparam)
        {
            return SendMessage(this.hWnd, Msg, new IntPtr(WParam), ref Lparam);
        }
        ...
        public WindowState State
        {
            get 
            {
                ...
                if (place.showCmd == 3) { return WindowState.Maximized; }
                else return WindowState.Minimized;
            }
            set 
            {
                if (value == WindowState.Minimized) { ShowWindow(hWnd, 6); }
                if (value == WindowState.Maximized) { ShowWindow(hWnd, 3); }
            }
        }
        ...
        List<Win32Window> GetAllWindows()
        {
            ...
            {
                returnee.Add(new Win32Window(tmp[i], false));
            }
        ...
        public Win32Window Parent
        {
            get
            {
                ...
                return new Win32Window(parent_hWnd, false);
            }
            set
            {
        ...
        public bool Enable()
        {
            return WinAPI.EnableWindow(this.hWnd, true) != 0;
        }

        public bool Disable()
        {
            return WinAPI.EnableWindow(this.hWnd, false) == 0;
        }
        ...
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool GetWindowSubclass(IntPtr hWnd, WindowsMessageSc pfnSubclass, IntPtr uIdSubclass, out IntPtr dwRefData);


        [DllImport("ComCtl32.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool SetWindowSubclass(IntPtr hWnd, WindowsMessageSc pfnSubclass, IntPtr uIdSubclass, IntPtr dwRefData);

        [DllImport("ComCtl32.dll")]
        [return: MarshalAs(UnmanagedType.Bool)]
        public static extern bool RemoveWindowSubclass(IntPtr hWnd, WindowsMessageSc pfnSubclass, IntPtr uIdSubclass);
    ...
    public struct RECT
    {
        ...
        public RECT(Microsoft.VisualStudio.OLE.Interop.RECT r) : this(r.left, r.top, r.right, r.bottom) { }
